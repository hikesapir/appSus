...
function removeReview(reviewId, book) {
    ...
    return book;
    // book.reviews.filter(review => review.id !== reviewId)
}
...
function saveNewBook(book) {
    ...
    var description = book.volumeInfo.description || 'No description'
    var publishedDate = book.volumeInfo.publishedDate.slice(0,4)
...
<router-link class="flex justify-center" to="/book">Go Back</router-link>
